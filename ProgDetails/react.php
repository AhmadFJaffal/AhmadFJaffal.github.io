                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="../Programs.html">Internship
                                    Programs</a></li>
                            <!--<li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>-->
                            <li class="breadcrumb-item"><a class="text-white" href="react.html">React</a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">React</h1>
                    <p class="mb-4">Dive into our React Internship program. Explore the power of components, JSX, Redux,
                        and Hooks in web development. Together, we'll guide you through the steps of building smooth and
                        responsive web apps using the latest React techniques. Boost your skills and be at the forefront
                        of modern web development.
                    <p class="mb-4">Instructors:<br>Start Date:<br>End Date:<br>
                    </p>
                    <div class="row gy-2 gx-4 mb-4">
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Max Capacity:</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Current Capacity:
                            </p>
                        </div>
                    </div>
