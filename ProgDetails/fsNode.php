                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="fsNode.php">Full-Stack Node</a>
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="../img/node.jpg" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Program Overview</h6>
                    <h1 class="mb-4">Full-Stack Node</h1>
                    <p class="mb-4">The Full Stack Node Web Development Internship offers hands-on experience with Node
                        and React. Learn to design attractive sites using HTML and CSS, enhance interactivity with
                        React, and ensure smooth back-end operations with Node. We'll explore essential tools within the
                        Node ecosystem, ensuring you're equipped to build efficient web applications from the ground up.
                        Dive in and kickstart your web development journey with us!
                    </p>
                    <p class="mb-4">Instructors: Suha Mneimneh , Sarah Merhi<br>Start Date: 2023-5-1<br>End Date: 2023-7-1<br>
                    </p>
