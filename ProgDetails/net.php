                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="../ProgDetails/net.php">ASP.NET</a>
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="../img/net.jpg" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Program Overview</h6>
                    <h1 class="mb-4">ASP.NET Core</h1>
                    <p class="mb-4">The Web Development - .NET Full Stack Internship Program is designed to provide you
                        with a well-rounded education in both front-end and back-end development using the .NET
                        framework. You will gain hands-on experience in crafting user interfaces, integrating database
                        systems, and building the logic that powers web applications.
                    <p class="mb-4">Instructors: Hussein Jawad<br>Start Date:2023-7-10<br>End Date:2023-9-10<br>
                    </p>
