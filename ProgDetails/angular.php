...
<body>
                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="angular.php">Angular</a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Angular</h1>
                    <p class="mb-4">Dive into our Angular Internship. Master the art of building dynamic web
                        applications with Angular. Sharpen your coding prowess and harness the power of this robust
                        framework with our guidance.
                    <p class="mb-4">Instructors: Sarah Merhi , Rabih Nehme<br>Start Date: 2023-6-10<br>End Date:2023-8-10<br>
                    </p>
    ...
    <!-- Footer End -->
    <!-- Back to Top -->
    <a href="angular.php" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
